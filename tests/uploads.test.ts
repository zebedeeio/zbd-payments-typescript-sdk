import fs from 'fs';
import type { ResponseLike } from 'zbd-payments/internal/to-file';
import { toFile } from 'zbd-payments/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('zbd-payments/core/uploads');
    await expect(
