...
describe('resource isSupportedRegion', () => {
  // skipped: tests are disabled for the time being
  test.skip('check', async () => {
    const responsePromise = client.isSupportedRegion.check('ip');
  ...
  test.skip('check: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.isSupportedRegion.check('ip', { apikey: 'apikey' }, { path: '/_stainless_unknown_path' }),
