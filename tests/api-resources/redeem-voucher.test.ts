...
describe('resource redeemVoucher', () => {
  // skipped: tests are disabled for the time being
  test.skip('redeem', async () => {
    const responsePromise = client.redeemVoucher.redeem();
  ...
  test.skip('redeem: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.redeemVoucher.redeem({ code: 'string', apikey: 'apikey' }, { path: '/_stainless_unknown_path' }),
